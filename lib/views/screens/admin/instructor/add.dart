...
class _AdminAddInstructorScreenState extends State<AdminAddInstructorScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      adminDB.updateInstructorStream();
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: StreamWrapper<Instructor>(
            stream: adminDB.instructorStream,
                        ...
                        children: [
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                          adminDB.sectionList[index].label!)),
                                ),
                              );
                            },
                          ),
                          ...
                          ElevatedButton(
                            onPressed: adminDB.validateAddInstructor
                                ? () {
                                    if (AdminDB
                                        .addInstructorFormKey.currentState!
                                        .validate()) {
